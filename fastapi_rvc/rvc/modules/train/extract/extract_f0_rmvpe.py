...
def extract_f0_feature_rmvpe(exp_dir, n_part, i_part, i_gpu, is_half):
    ...
    printt(f"Parameters: exp_dir={exp_dir}, n_part={n_part}, i_part={i_part}, i_gpu={i_gpu}, is_half={is_half}")
